# ====================================================================================
# Setup Project
PROJECT_NAME := provider-nokiacontainerservices
...
IMAGES = provider-nokiacontainerservices
...
XPKGS = provider-nokiacontainerservices
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-nokiacontainerservices: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider NokiaContainerServices CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider NokiaContainerServices controllers
...
# This target prepares repo for your provider by replacing all "nokiacontainerservices"
