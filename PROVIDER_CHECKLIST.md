...
The [provider-nokiacontainerservices](https://github.com/crossplane/provider-nokiacontainerservices) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-nokiacontainerservices](https://github.com/crossplane-contrib/provider-jet-nokiacontainerservices) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-nokiacontainerservices/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-nokiacontainerservices/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-nokiacontainerservices/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-nokiacontainerservices/blob/main/hack/boilerplate.go.txt)
...
The [provider-nokiacontainerservices](https://github.com/crossplane/provider-nokiacontainerservices)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-nokiacontainerservices/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-nokiacontainerservices/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue nokiacontainerservicess (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-nokiacontainerservices/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request NokiaContainerServicess: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-nokiacontainerservices/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
